...
class Agent():
    ...
    def __init__(self, state_size, action_size, memory, random_seed, num_agents):
        ...
        self.actor_local = Actor(state_size, action_size, self.params.random_seed).to(device)
        self.actor_target = Actor(state_size, action_size, self.params.random_seed).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=self.params.lr_actor)

        # Critic Network (w/ Target Network)
        self.critic_local = Critic(state_size, action_size, self.params.random_seed).to(device)
        self.critic_target = Critic(state_size, action_size, self.params.random_seed).to(device)
    ...
    def learn(self, experiences, gamma):
        ...
        torch.nn.utils.clip_grad_norm_(self.critic_local.parameters(), 1) # play with this
...
class OUNoise:
    ...
    def __init__(self, seed, size, mu, theta, sigma):
